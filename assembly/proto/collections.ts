...
export namespace collections {
  ...
  @unmanaged
  export class mint_start_time_arguments {
    static encode(message: mint_start_time_arguments, writer: Writer): void {}

    static decode(reader: Reader, length: i32): mint_start_time_arguments {
      const end: usize = length < 0 ? reader.end : reader.ptr + length;
      const message = new mint_start_time_arguments();
  ...
  @unmanaged
  export class mint_started_arguments {
    static encode(message: mint_started_arguments, writer: Writer): void {}

    static decode(reader: Reader, length: i32): mint_started_arguments {
      const end: usize = length < 0 ? reader.end : reader.ptr + length;
      const message = new mint_started_arguments();
