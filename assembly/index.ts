...
export function main(): i32 {
  ...
  switch (contractArgs.entry_point) {
    ...
    case 0x158eb425: {
      const args = Protobuf.decode<ProtoNamespace.mint_start_time_arguments>(
        contractArgs.args,
        ProtoNamespace.mint_start_time_arguments.decode
      );
      const res = c.mint_start_time(args);
      retbuf = Protobuf.encode(res, ProtoNamespace.uint64_object.encode);
      break;
    }

    case 0xcb1d0358: {
      const args = Protobuf.decode<ProtoNamespace.mint_started_arguments>(
        contractArgs.args,
        ProtoNamespace.mint_started_arguments.decode
      );
      const res = c.mint_started(args);
      retbuf = Protobuf.encode(res, ProtoNamespace.bool_object.encode);
      break;
    }
